...
class Program
{
    static void Main(string[] args)
    {
        ...
        book1.SetBookInfo("Моя борьба", "Степанов");
        book1.SetPublicationInfo(new DateTime(2003, 12, 28), 360);

        book2.SetBookInfo("12 стульев", "Ильф и Петров");
        book2.SetPublicationInfo(new DateTime(2020, 12, 31), 200);
